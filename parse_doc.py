    ...
    for paragraph in paragraphs:
        ...
        if m:
            ...
            if m:
                ...
                logger.error("ERROR: Unexpected transformation metadata format %s" %
                             combined_contents)
                return None
            clean_paragraphs.append({'text': clean_text})
...
def transform_speaker(paragraph):
    ...
    if m:
        ...
        logger.error("ERROR: Unexpected speaker metadata format %s" %
                     combined_contents)
        return paragraph
...
def transform_soundbite(paragraph):
    ...
    if m:
        ...
        logger.error("ERROR: Unexpected soundbite metadata format %s" %
                     combined_contents)
        return paragraph
